...
public class AdjacencyListGraph<T> {
    ...
    public static List<GraphNode> depthFirstGraph(AdjacencyListGraph graph) {
        ...
        for (GraphNode node : (Set<GraphNode>) graph.adjacencyList) {
            ...
            while (dfs.peek() != null) {
                ...
                seen.add(node);
                results.add(node);
                for (Edge n : (Set<Edge>) node.neighbors) {
                    if (!seen.contains(n.getEnd())) {
                        dfs.push(n.getEnd());
                    }
                }
            }
    ...
    //        AdjacencyListGraph classToTest = new AdjacencyListGraph();
    //
    //        //input is what to test for in the graph
    //        List<String> cities = new ArrayList<>();
    //        cities.add("s");
    //        cities.add("w");
    //
    ...
    //
    //        List<GraphNode> actual = classToTest.
    //
    //
    //
    //    }
